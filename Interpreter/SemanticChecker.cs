...
namespace SimpleC
{
    public class SemanticChecker
    {
        ...
        public SemanticChecker(ITree programNode)
        {
			if (programNode.Type != AstNodeType.PROGRAM)
			{
                Console.Error.WriteLine(String.Format("Node: {0}", SimpleC.Grammar.SimpleCParser.tokenNames[programNode.Type]));
        ...
        {
            SemanticChecker sch = new SemanticChecker(programNode);
            sch.Execute();
        }
    }
}
