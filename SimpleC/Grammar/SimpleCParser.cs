...
// $ANTLR 3.4 Grammar\\SimpleC.g 2015-10-06 22:22:16
...
public partial class SimpleCParser : Antlr.Runtime.Parser
{
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> funcDecl()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: identifier, typeSpec, paramSpecList
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> funcDef()
	{
		...
		try
		{
			...
			{
			// AST REWRITE
			// elements: funcBody, typeSpec, paramSpecList, identifier
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> unaryExpr()
	{
		...
		try
		{
			...
			case 1:
				...
				{
				DebugLocation(167, 2);
				char_literal39=(CommonToken)Match(input,MUL,Follow._MUL_in_unaryExpr1357); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_MUL.Add(char_literal39);

				DebugLocation(167, 6);
				PushFollow(Follow._unaryExpr_in_unaryExpr1359);
			...
			case 2:
				...
				{
				DebugLocation(168, 4);
				char_literal41=(CommonToken)Match(input,BIT_AND,Follow._BIT_AND_in_unaryExpr1372); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_BIT_AND.Add(char_literal41);

				DebugLocation(168, 8);
				PushFollow(Follow._unaryExpr_in_unaryExpr1374);
			...
			case 3:
				...
				{
				DebugLocation(169, 4);
				char_literal43=(CommonToken)Match(input,ADD,Follow._ADD_in_unaryExpr1387); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_ADD.Add(char_literal43);

				DebugLocation(169, 8);
				PushFollow(Follow._unaryExpr_in_unaryExpr1389);
			...
			case 4:
				...
				{
				DebugLocation(170, 4);
				char_literal45=(CommonToken)Match(input,SUB,Follow._SUB_in_unaryExpr1402); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_SUB.Add(char_literal45);

				DebugLocation(170, 8);
				PushFollow(Follow._unaryExpr_in_unaryExpr1404);
			...
			case 5:
				...
				{
				DebugLocation(171, 4);
				char_literal47=(CommonToken)Match(input,61,Follow._61_in_unaryExpr1417); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_61.Add(char_literal47);

				DebugLocation(171, 8);
				PushFollow(Follow._unaryExpr_in_unaryExpr1419);
			...
			case 6:
				...
				{
				DebugLocation(172, 4);
				char_literal49=(CommonToken)Match(input,74,Follow._74_in_unaryExpr1432); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_74.Add(char_literal49);

				DebugLocation(172, 8);
				PushFollow(Follow._unaryExpr_in_unaryExpr1434);
			...
			case 7:
				...
				{
				DebugLocation(173, 4);
				string_literal51=(CommonToken)Match(input,64,Follow._64_in_unaryExpr1447); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_64.Add(string_literal51);

				DebugLocation(173, 9);
				PushFollow(Follow._unaryExpr_in_unaryExpr1449);
			...
			case 8:
				...
				{
				DebugLocation(174, 4);
				string_literal53=(CommonToken)Match(input,66,Follow._66_in_unaryExpr1462); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_66.Add(string_literal53);

				DebugLocation(174, 9);
				PushFollow(Follow._unaryExpr_in_unaryExpr1464);
			...
			case 9:
				...
				{
				DebugLocation(175, 4);
				char_literal55=(CommonToken)Match(input,62,Follow._62_in_unaryExpr1477); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_62.Add(char_literal55);

				DebugLocation(175, 8);
				PushFollow(Follow._typeSpec_in_unaryExpr1479);
				typeSpec56=typeSpec();
				PopFollow();
				if (state.failed) return retval;
				if (state.backtracking == 0) stream_typeSpec.Add(typeSpec56.Tree);
				DebugLocation(175, 17);
				char_literal57=(CommonToken)Match(input,63,Follow._63_in_unaryExpr1481); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_63.Add(char_literal57);

				DebugLocation(175, 21);
				PushFollow(Follow._unaryExpr_in_unaryExpr1483);
			...
			case 10:
				...
				{
				DebugLocation(176, 4);
				SizeOf59=(CommonToken)Match(input,SizeOf,Follow._SizeOf_in_unaryExpr1498); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_SizeOf.Add(SizeOf59);

				DebugLocation(176, 11);
				PushFollow(Follow._unaryExpr_in_unaryExpr1500);
			...
			case 11:
				...
				{
				DebugLocation(177, 4);
				SizeOf61=(CommonToken)Match(input,SizeOf,Follow._SizeOf_in_unaryExpr1513); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_SizeOf.Add(SizeOf61);

				DebugLocation(177, 11);
				char_literal62=(CommonToken)Match(input,62,Follow._62_in_unaryExpr1515); if (state.failed) return retval; 
				if (state.backtracking == 0) stream_62.Add(char_literal62);

				DebugLocation(177, 15);
				PushFollow(Follow._typeSpec_in_unaryExpr1517);
				typeSpec63=typeSpec();
				PopFollow();
				if (state.failed) return retval;
				if (state.backtracking == 0) stream_typeSpec.Add(typeSpec63.Tree);
				DebugLocation(177, 24);
				char_literal64=(CommonToken)Match(input,63,Follow._63_in_unaryExpr1519); if (state.failed) return retval; 
			...
			case 12:
				...
				DebugLocation(178, 4);
				PushFollow(Follow._primaryExpr_in_unaryExpr1532);
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> primaryExpr()
	{
		...
		try
		{
			...
			DebugLocation(187, 7);
			PushFollow(Follow._basicExpr_in_primaryExpr1550);
			basic=basicExpr();
			PopFollow();
			if (state.failed) return retval;
			...
			while (true)
			{
				...
				case 1:
					...
					{
					DebugLocation(191, 4);
					char_literal66=(CommonToken)Match(input,70,Follow._70_in_primaryExpr1560); if (state.failed) return retval;
					if (state.backtracking == 0) {
					char_literal66_tree = (CommonTree)adaptor.Create(char_literal66);
					adaptor.AddChild(root_0, char_literal66_tree);
					}
					DebugLocation(191, 11);
					PushFollow(Follow._expr_in_primaryExpr1564);
					idx=expr();
					PopFollow();
					if (state.failed) return retval;
					if (state.backtracking == 0) adaptor.AddChild(root_0, idx.Tree);
					DebugLocation(191, 17);
					char_literal67=(CommonToken)Match(input,71,Follow._71_in_primaryExpr1566); if (state.failed) return retval;
					if (state.backtracking == 0) {
				...
				case 2:
					...
					{
					DebugLocation(195, 5);
					char_literal68=(CommonToken)Match(input,68,Follow._68_in_primaryExpr1575); if (state.failed) return retval;
					if (state.backtracking == 0) {
					char_literal68_tree = (CommonTree)adaptor.Create(char_literal68);
					adaptor.AddChild(root_0, char_literal68_tree);
					}
					DebugLocation(195, 15);
					PushFollow(Follow._identifier_in_primaryExpr1579);
					member=identifier();
					PopFollow();
					if (state.failed) return retval;
				...
				case 3:
					...
					{
					DebugLocation(199, 5);
					string_literal69=(CommonToken)Match(input,67,Follow._67_in_primaryExpr1587); if (state.failed) return retval;
					if (state.backtracking == 0) {
					string_literal69_tree = (CommonTree)adaptor.Create(string_literal69);
					adaptor.AddChild(root_0, string_literal69_tree);
					}
					DebugLocation(199, 16);
					PushFollow(Follow._identifier_in_primaryExpr1591);
					member=identifier();
					PopFollow();
					if (state.failed) return retval;
					if (state.backtracking == 0) adaptor.AddChild(root_0, member.Tree);
				...
				case 4:
					...
					{
					DebugLocation(203, 5);
					string_literal70=(CommonToken)Match(input,64,Follow._64_in_primaryExpr1599); if (state.failed) return retval;
					if (state.backtracking == 0) {
				...
				case 5:
					...
					{
					DebugLocation(207, 5);
					string_literal71=(CommonToken)Match(input,66,Follow._66_in_primaryExpr1607); if (state.failed) return retval;
					if (state.backtracking == 0) {
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> basicExpr()
	{
		...
		try
		{
			...
			case 1:
				...
				DebugLocation(226, 5);
				char_literal72=(CommonToken)Match(input,62,Follow._62_in_basicExpr1627); if (state.failed) return retval;
				DebugLocation(226, 7);
				PushFollow(Follow._expr_in_basicExpr1630);
				expr73=expr();
				PopFollow();
				if (state.failed) return retval;
				if (state.backtracking == 0) adaptor.AddChild(root_0, expr73.Tree);
				DebugLocation(226, 15);
				char_literal74=(CommonToken)Match(input,63,Follow._63_in_basicExpr1632); if (state.failed) return retval;
			...
			case 2:
				...
				DebugLocation(227, 4);
				PushFollow(Follow._identifier_in_basicExpr1638);
			...
			case 3:
				...
				DebugLocation(228, 4);
				PushFollow(Follow._integer_in_basicExpr1644);
				integer76=integer();
				PopFollow();
				if (state.failed) return retval;
			...
			case 4:
				...
				DebugLocation(229, 4);
				PushFollow(Follow._funcCall_in_basicExpr1650);
				funcCall77=funcCall();
				PopFollow();
				if (state.failed) return retval;
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> funcCall()
	{
		...
		try
		{
			...
			{
			DebugLocation(233, 2);
			PushFollow(Follow._identifier_in_funcCall1659);
			identifier78=identifier();
			PopFollow();
			if (state.failed) return retval;
			if (state.backtracking == 0) stream_identifier.Add(identifier78.Tree);
			DebugLocation(233, 13);
			char_literal79=(CommonToken)Match(input,62,Follow._62_in_funcCall1661); if (state.failed) return retval; 
			if (state.backtracking == 0) stream_62.Add(char_literal79);

			DebugLocation(233, 17);
			PushFollow(Follow._paramList_in_funcCall1663);
			paramList80=paramList();
			PopFollow();
			if (state.failed) return retval;
			if (state.backtracking == 0) stream_paramList.Add(paramList80.Tree);
			DebugLocation(233, 27);
			char_literal81=(CommonToken)Match(input,63,Follow._63_in_funcCall1665); if (state.failed) return retval; 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> identifier()
	{
		...
		try
		{
			...
			{
			DebugLocation(260, 2);
			Identifier83=(CommonToken)Match(input,Identifier,Follow._Identifier_in_identifier1732); if (state.failed) return retval; 
	...
	private AstParserRuleReturnScope<CommonTree, CommonToken> integer()
	{
		...
		try
		{
			...
			{
			DebugLocation(266, 2);
			Integer84=(CommonToken)Match(input,Integer,Follow._Integer_in_integer1745); if (state.failed) return retval; 
	...
	public void synpred9_SimpleC_fragment()
	{
		...
		try
		{
			...
			{
			DebugLocation(175, 4);
			Match(input,62,Follow._62_in_synpred9_SimpleC1477); if (state.failed) return;
			DebugLocation(175, 8);
			PushFollow(Follow._typeSpec_in_synpred9_SimpleC1479);
			typeSpec();
			PopFollow();
			if (state.failed) return;
			DebugLocation(175, 17);
			Match(input,63,Follow._63_in_synpred9_SimpleC1481); if (state.failed) return;
			DebugLocation(175, 21);
			PushFollow(Follow._unaryExpr_in_synpred9_SimpleC1483);
			unaryExpr();
			PopFollow();
			if (state.failed) return;
	...
	public void synpred10_SimpleC_fragment()
	{
		...
		try
		{
			...
			{
			DebugLocation(176, 4);
			Match(input,SizeOf,Follow._SizeOf_in_synpred10_SimpleC1498); if (state.failed) return;
			DebugLocation(176, 11);
			PushFollow(Follow._unaryExpr_in_synpred10_SimpleC1500);
			unaryExpr();
			PopFollow();
			if (state.failed) return;
	...
	public void synpred11_SimpleC_fragment()
	{
		...
		try
		{
			...
			{
			DebugLocation(177, 4);
			Match(input,SizeOf,Follow._SizeOf_in_synpred11_SimpleC1513); if (state.failed) return;
			DebugLocation(177, 11);
			Match(input,62,Follow._62_in_synpred11_SimpleC1515); if (state.failed) return;
			DebugLocation(177, 15);
			PushFollow(Follow._typeSpec_in_synpred11_SimpleC1517);
			typeSpec();
			PopFollow();
			if (state.failed) return;
			DebugLocation(177, 24);
			Match(input,63,Follow._63_in_synpred11_SimpleC1519); if (state.failed) return;
	...
	private static class Follow
	{
		...
		public static readonly BitSet _MUL_in_unaryExpr1357 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1359 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _BIT_AND_in_unaryExpr1372 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1374 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _ADD_in_unaryExpr1387 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1389 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _SUB_in_unaryExpr1402 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1404 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _61_in_unaryExpr1417 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1419 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _74_in_unaryExpr1432 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1434 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _64_in_unaryExpr1447 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1449 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _66_in_unaryExpr1462 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1464 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _62_in_unaryExpr1477 = new BitSet(new ulong[]{0x800000040000000UL});
		public static readonly BitSet _typeSpec_in_unaryExpr1479 = new BitSet(new ulong[]{0x8000000000000000UL});
		public static readonly BitSet _63_in_unaryExpr1481 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1483 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _SizeOf_in_unaryExpr1498 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_unaryExpr1500 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _SizeOf_in_unaryExpr1513 = new BitSet(new ulong[]{0x4000000000000000UL});
		public static readonly BitSet _62_in_unaryExpr1515 = new BitSet(new ulong[]{0x800000040000000UL});
		public static readonly BitSet _typeSpec_in_unaryExpr1517 = new BitSet(new ulong[]{0x8000000000000000UL});
		public static readonly BitSet _63_in_unaryExpr1519 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _primaryExpr_in_unaryExpr1532 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _basicExpr_in_primaryExpr1550 = new BitSet(new ulong[]{0x2UL,0x5DUL});
		public static readonly BitSet _70_in_primaryExpr1560 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _expr_in_primaryExpr1564 = new BitSet(new ulong[]{0x0UL,0x80UL});
		public static readonly BitSet _71_in_primaryExpr1566 = new BitSet(new ulong[]{0x2UL,0x5DUL});
		public static readonly BitSet _68_in_primaryExpr1575 = new BitSet(new ulong[]{0x20000000UL});
		public static readonly BitSet _identifier_in_primaryExpr1579 = new BitSet(new ulong[]{0x2UL,0x5DUL});
		public static readonly BitSet _67_in_primaryExpr1587 = new BitSet(new ulong[]{0x20000000UL});
		public static readonly BitSet _identifier_in_primaryExpr1591 = new BitSet(new ulong[]{0x2UL,0x5DUL});
		public static readonly BitSet _64_in_primaryExpr1599 = new BitSet(new ulong[]{0x2UL,0x5DUL});
		public static readonly BitSet _66_in_primaryExpr1607 = new BitSet(new ulong[]{0x2UL,0x5DUL});
		public static readonly BitSet _62_in_basicExpr1627 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _expr_in_basicExpr1630 = new BitSet(new ulong[]{0x8000000000000000UL});
		public static readonly BitSet _63_in_basicExpr1632 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _identifier_in_basicExpr1638 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _integer_in_basicExpr1644 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _funcCall_in_basicExpr1650 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _identifier_in_funcCall1659 = new BitSet(new ulong[]{0x4000000000000000UL});
		public static readonly BitSet _62_in_funcCall1661 = new BitSet(new ulong[]{0xE0050008A0000050UL,0x405UL});
		public static readonly BitSet _paramList_in_funcCall1663 = new BitSet(new ulong[]{0x8000000000000000UL});
		public static readonly BitSet _63_in_funcCall1665 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _Identifier_in_identifier1732 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _Integer_in_integer1745 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _62_in_synpred9_SimpleC1477 = new BitSet(new ulong[]{0x800000040000000UL});
		public static readonly BitSet _typeSpec_in_synpred9_SimpleC1479 = new BitSet(new ulong[]{0x8000000000000000UL});
		public static readonly BitSet _63_in_synpred9_SimpleC1481 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_synpred9_SimpleC1483 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _SizeOf_in_synpred10_SimpleC1498 = new BitSet(new ulong[]{0x60050008A0000050UL,0x405UL});
		public static readonly BitSet _unaryExpr_in_synpred10_SimpleC1500 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _SizeOf_in_synpred11_SimpleC1513 = new BitSet(new ulong[]{0x4000000000000000UL});
		public static readonly BitSet _62_in_synpred11_SimpleC1515 = new BitSet(new ulong[]{0x800000040000000UL});
		public static readonly BitSet _typeSpec_in_synpred11_SimpleC1517 = new BitSet(new ulong[]{0x8000000000000000UL});
		public static readonly BitSet _63_in_synpred11_SimpleC1519 = new BitSet(new ulong[]{0x2UL});
	}
